...
## Build
Clone. Download [ImGui 1.8](https://github.com/ocornut/imgui/tree/v1.80). Extract to the cloned directory. Run the bat file. The dll will be in the out directory.
